...
def eakf(ensemble_size, nobsgrid, zens, Hk, obs_error_var, localize, CMat, zobs, debug=False):
    '''
    ...
    for iobs in range(0, nobsgrid): # for each observation coef:
        ...
        if debug: print('pbht: ', pbht.shape)
